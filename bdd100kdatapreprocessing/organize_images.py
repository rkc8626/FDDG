...
SOURCE_DIR = os.path.join(BASE_DIR, 'Data/bdd100k_person/cropped_persons')
TARGET_DIR = os.path.join(BASE_DIR, 'Data/bdd100k_person/processed_6k_new')
LABELS_FILE = os.path.join(BASE_DIR, 'Data/bdd100k_person/fair_labels_removeNoLabledGender.json')
